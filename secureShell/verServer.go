...
var host = "www.example.com:22"
var privateKeyFile = "/home/user/.ssh/id_rsa"

// Known Host only read FIRST entry
...
func main() {
	...
	/*
		Note that, in addition to the ssh.KeyAlgo* constants, there are
		ssh.CertAlgo* constants if certificates are used.
	*/
